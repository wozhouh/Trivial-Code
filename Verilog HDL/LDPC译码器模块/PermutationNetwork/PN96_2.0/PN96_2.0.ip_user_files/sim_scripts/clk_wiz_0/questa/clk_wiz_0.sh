...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/shane/Desktop/Practicum/Programming/Project/FinalPN/PermutationNetwork2008_2.0/PermutationNetwork2008_2.0.cache/compile_simlib/questa"
  fi
